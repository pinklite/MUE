...
Curium-Project/Curium repository.
...
Setup
---------
Configuring the github-merge tool for the Curium repository is done in the following way:

    git config githubmerge.repository Curium-Project/Curium
...
A script to optimize png files in the Curium
