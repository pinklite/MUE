...
In order to support loading of multiple wallets in curium-qt, a few changes in the UI architecture will be needed.
...
----------------------
curium.cpp is the entry point into curium-qt, and as such, will require some minor modifications to provide hooks for
