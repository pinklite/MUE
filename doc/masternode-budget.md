...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<curium_address\> \<monthly_payment_curium\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Curium, _12_ times over the course of a year totaling _24000_ Curium.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<curium_address\> \<monthly_payment_curium\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Curium.
