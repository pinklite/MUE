                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzcruPathCustom = GetArg("-zcrubackuppath", "");
    ...
    if(!strzcruPathCustom.empty()) {
        ui->wallet_customzcrubackuppath->setText(QString::fromStdString(strzcruPathCustom));
        ui->wallet_customzcrubackuppath_label->setVisible(true);
        ui->wallet_customzcrubackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzcruPathCustom.empty()) && nCustomBackupThreshold > 0) {
