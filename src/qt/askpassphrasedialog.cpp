                                                                                           ...
                                                                                           fCapsLock(false)
{
    ...
    ui->passEdit1->setMaxLength(MAX_PASSCRUASE_SIZE);
    ui->passEdit2->setMaxLength(MAX_PASSCRUASE_SIZE);
    ui->passEdit3->setMaxLength(MAX_PASSCRUASE_SIZE);
...
void AskPassphraseDialog::accept()
{
    ...
    if (!model)
        return;
    oldpass.reserve(MAX_PASSCRUASE_SIZE);
    newpass1.reserve(MAX_PASSCRUASE_SIZE);
    newpass2.reserve(MAX_PASSCRUASE_SIZE);
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Curium will close now to finish the encryption process. "
                               ...
                               "your CRUs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
