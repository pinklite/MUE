 ...
 */
    ...
    typeWidget->addItem(tr("Received Cru from zCru"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCru"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCru));
