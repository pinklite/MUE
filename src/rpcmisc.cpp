...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total curium balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zCRUsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zCRU denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zCRU denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zCRU denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zCRU denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zCRU denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zCRU denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zCRU denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zCRU denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zCRU denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in curium/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in curium/kb\n"
    ...
    UniValue zcruObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zcruObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zcruObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zCRUsupply", zcruObj));
