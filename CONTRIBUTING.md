...
The Curium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Curium Core project, and is not to be
confused with overall Curium Network Protocol consensus changes.

Whether a pull request is merged into Curium Core rests with the project merge
...
Patches that change Curium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Curium consensus, it must have been
