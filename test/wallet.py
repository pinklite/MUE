...
#   c) node1 mines 32 blocks, so now node 0 has 60001cru, node 1 has 4250cru, node2 has none.
#   d) node0 sends 601 cru to node2, in two transactions (301 cru, then 300 cru).
